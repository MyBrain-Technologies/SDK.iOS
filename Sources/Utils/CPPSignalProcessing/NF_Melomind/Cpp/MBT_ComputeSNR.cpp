...
//          Fanny Grosselin : 2018/06/07 Manage a possible exception in the detection of the bounds of the alpha peak.
//          Fanny Grosselin : 2018/06/07 Manage the case where the spectrum is NaN (may happen when the signal is constant).
