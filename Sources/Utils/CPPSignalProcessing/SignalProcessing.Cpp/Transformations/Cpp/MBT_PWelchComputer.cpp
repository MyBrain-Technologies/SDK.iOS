...
//          Fanny Grosselin 2017/03/23 --> Change float by double and use the double functions of MBT_Fourier_fftw3 because fftwf can't be used for the moment in Androïd
...
void MBT_PWelchComputer::computePSD()
{
    ...
    int tmp_powerOfTwoLength = pow(2, ceil(log(2 * windowLength - 1)/log(2))); // Fanny Grosselin 2017/01/17
