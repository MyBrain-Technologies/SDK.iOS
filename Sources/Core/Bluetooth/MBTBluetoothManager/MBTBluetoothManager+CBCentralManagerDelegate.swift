...
//  }
  ...
  internal func didBluetoothPoweredOn() {
  ...
  internal func didBluetoothPoweredOff() {
...
//  }
  ...
  internal func peripheralDisconnectedDuringOAD() {
...
//    peripheralIO.peripheral = nil
  ...
  internal func peripheralDisconnected(error: Error?) {
