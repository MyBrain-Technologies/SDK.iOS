...
public class MBTEEGPacket: Object {
    ...
    func addValues(_ values: Array<Array<ChannelData>>) {
    ...
    class func addValuesToEEGPacket(_ datasArray: Array<Array<ChannelData>>,lastPacket:MBTEEGPacket) -> StreamEEGPacketToSend {
